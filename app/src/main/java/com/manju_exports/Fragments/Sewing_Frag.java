...
public class Sewing_Frag extends Fragment implements View.OnClickListener {
    ...
    private ConstraintLayout
            ...
            constraintLayout_bundle_num_layout_inside,
            constraintLayout_operation_layout,
            constraintLayout_select_shift,
            constraintLayout_tailor_layout;

    public static ScrollView scroll_view_layout;
    public static ConstraintLayout constraintLayout_inside_io_number_color,
            constraintLayout_inside_api_values,
            constraintLayout_opertions;
    ...
    private TextView
            ...
            tv_onclick_bundle_number_manual_entry_txt,
            tv_bundle_number_normal_manual_entry_txt,
    ...
    private String
            ...
            str_session_bundle_number_pick_manual_entry,
    ...
    private Bundle_Number_Adapter_For_Checking bundle_number_adapter_for_checking;
...
//        Objects.requireNonNull(getActivity()).getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        constraintLayout_bundle_num_layout_inside = view.findViewById(R.id.constraintLayout_bundle_num_layout_inside);
        constraintLayout_inside_api_values = view.findViewById(R.id.constraintLayout_inside_api_values);
        constraintLayout_opertions = view.findViewById(R.id.constraintLayout_opertions);
        ...
        tv_onclick_bundle_number_manual_entry_txt = view.findViewById(R.id.tv_onclick_bundle_number_manual_entry_txt);
        tv_bundle_number_normal_manual_entry_txt = view.findViewById(R.id.tv_bundle_number_normal_manual_entry_txt);
        ...
        constraintLayout_bundle_num_layout_inside.setOnClickListener(this);
        ...
        str_session_bundle_number_pick_manual_entry = SessionSave.getSession("Session_Bundle_Number_Pick_Manual_Entry", getActivity());
...
//            Log.e("str_qrcode_value_log", str_qrcode_value);
        ...
        if (!(str_session_checking_person_dummy.equalsIgnoreCase("No data"))) {
            ...
            /*else {
                Log.e("elseeee", str_session_checking_person_dummy);
                tv_onclick_tailor_txt.setText(str_session_checking_person_dummy);
                tv_normal_tailor_txt.setText("");
                SessionSave.SaveSession("Session_Checking_Person_Sewing_dummy", tv_onclick_tailor_txt.getText().toString(), getActivity());
            }*/
        ...
        if (!(str_session_io_number_manual_entry.equalsIgnoreCase("No data"))) {
            ...
            tv_io_number_normal_manual_entry_txt.setText(R.string.io_no_txt);
        }
        ...
        if (!(str_session_bundle_number_pick_manual_entry.equalsIgnoreCase("No data"))) {
            tv_onclick_bundle_number_manual_entry_txt.setText(str_session_bundle_number_pick_manual_entry);
            tv_bundle_number_normal_manual_entry_txt.setText("");
        } else {
            tv_bundle_number_normal_manual_entry_txt.setText(R.string.bundle_number_txt);
        }
...
//                            Toast.makeText(getActivity(), "Null", Toast.LENGTH_SHORT).show();
                            ...
                            constraintLayout_scanning_result_values.setVisibility(View.GONE);
                            constraintLayout_inside_api_values.setVisibility(View.GONE);
                            constraintLayout_opertions.setVisibility(View.GONE);
                            ...
                            if (response.isSuccessful()) {
                                ...
                                constraintLayout_scanning_result_values.setVisibility(View.VISIBLE);
                                constraintLayout_inside_api_values.setVisibility(View.VISIBLE);
                                constraintLayout_opertions.setVisibility(View.VISIBLE);
                                tv_scan_again.setVisibility(View.VISIBLE);
                                scroll_view_layout.setVisibility(View.VISIBLE);
                                constraintLayout_qr_code_scan.setVisibility(View.VISIBLE);
...
//        Log.e("backStackCnt_wallet", "" + backStackEntryCount);
        ...
        if (constraintLayout_sewing_rv_layout.getVisibility() == View.VISIBLE) {
//            Toast.makeText(getActivity(), "bacckpresee FRAGMENT", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(getActivity(), Home_Activity.class);
            startActivity(intent);
            getActivity().overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        } else if (scroll_view_layout.getVisibility() == View.VISIBLE || constraintLayout_inside_io_number_color.getVisibility() == View.VISIBLE) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.constraintLayout_io_number_layout_inside:
                dialog_for_io_number = new Dialog(requireActivity());
                ...
                tv_onclick_bundle_number_manual_entry_txt.setText("");
                tv_bundle_number_normal_manual_entry_txt.setText(R.string.bundle_number_txt);
                break;
            case R.id.constraintLayout_color_layout_inside:
                if (tv_onclick_io_number_manual_entry_txt.getText().toString().isEmpty()) {
                    ...
                    dialog_for_colors = new Dialog(requireActivity());
                ...
                break;
            case R.id.constraintLayout_bundle_num_layout_inside:
                if (tv_onclick_io_number_manual_entry_txt.getText().toString().isEmpty()) {
                    Toast.makeText(getActivity(), "Please Select Io Number", Toast.LENGTH_SHORT).show();
                } else {
                    dialog_for_bundle_number = new Dialog(requireActivity());
                    dialog_for_bundle_number.setContentView(R.layout.bundle_number_select_alert_for_sewing);
                    rv_bundle_number = dialog_for_bundle_number.findViewById(R.id.rv_bundle_number);
                    rv_bundle_number.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                    rv_bundle_number.setHasFixedSize(true);
                    dialog_for_bundle_number.setCancelable(true);
                    Get_Bundle_Number_Details();
                    dialog_for_bundle_number.show();
                }
                break;
...
//                        Log.e("Game_Entry_Point_Value_logggg_Elseee", SessionSave.getSession("Game_Entry_Point_Value", getActivity()));
            ...
            case R.id.constraintLayout_tailor_layout:
                final Dialog dialog_01 = new Dialog(requireActivity());
                ...
                tv_list_01.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog_01.dismiss();
                        dialog_for_tailor = new Dialog(requireActivity());
...
//                Log.e("tv_onclick_io_number_manual_entry_txt_logg", tv_onclick_io_number_manual_entry_txt.getText().toString());
                String s1 = SessionSave.getSession("Game_Entry_Point_Value", requireActivity());
//                Log.e("s1_s1_s1", s1);
                if (s1.equals("1")) {
                    if (tv_io_number.getText().toString().isEmpty()) {
                        ...
                        Get_Operation_Call();
                        dialog_for_operation = new Dialog(requireActivity());
            ...
            case R.id.constraintLayout_select_shift:
                dialog_for_shift_timing = new Dialog(requireActivity());
...
//                        fab.setVisibility(View.VISIBLE);
                ...
                break;
            case R.id.fab:
                final Dialog dialog_fab = new Dialog(requireActivity());
                ...
                SessionSave.clearSession("Game_Entry_Point_Value", requireActivity());
                tv_scan_fab.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        int_fab_onlick_value = 1;
                        SessionSave.SaveSession("Game_Entry_Point_Value", String.valueOf(int_fab_onlick_value), getActivity());
//                        Log.e("int_fab_onlick_value_01", SessionSave.getSession("Game_Entry_Point_Value", getActivity()));
                        dialog_fab.dismiss();
                        scroll_view_layout.setVisibility(View.VISIBLE);
                        btn_save_new.setVisibility(View.GONE);
                        constraintLayout_qr_code_scan.setVisibility(View.GONE);
...
//                        initialiseDetectorsAndSources();
                ...
                tv_manual.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        SessionSave.SaveSession("Game_Entry_Point_Value", String.valueOf(int_fab_onlick_value), getActivity());
//                        Log.e("int_fab_onlick_value_02", SessionSave.getSession("Game_Entry_Point_Value", getActivity()));
                        dialog_fab.dismiss();
                        constraintLayout_qr_code_scan.setVisibility(View.VISIBLE);
                        constraintLayout_opertions.setVisibility(View.VISIBLE);
                        scroll_view_layout.setVisibility(View.VISIBLE);
...
//                        Log.e("Game_Entry_Point_Value_logggg_Elseee", SessionSave.getSession("Game_Entry_Point_Value", getActivity()));
                        ...
                        constraintLayout_scanning_result_values.setBackground(getResources().getDrawable(R.drawable.sewing_card_white_bg));

                        Log.e("Session_Checking_Person_Sewing_dummy_loggg", SessionSave.getSession("Session_Checking_Person_Sewing_dummy", getActivity()));


                        Log.e("tv_onclick_io_number_manual_entry_txt_manual_entry", tv_onclick_io_number_manual_entry_txt.getText().toString());
                        Log.e("tv_onclick_color_manual_entry_txt_manual_entry", tv_onclick_color_manual_entry_txt.getText().toString());
                        Log.e("tv_onclick_tailor_txt_manual_entry", tv_onclick_tailor_txt.getText().toString());
                        Log.e("tv_onclick_operation_manual_entry", tv_onclick_operation.getText().toString());
                        Log.e("tv_onclick_shift_manual_entry", tv_onclick_shift.getText().toString());
                        Log.e("tv_onclick_select_piece_for_sewing̥_manual_entry", tv_onclick_select_piece_for_sewing.getText().toString());
...
//                Log.e("int_fab_onlick_value_eeeee̥", String.valueOf(int_fab_onlick_value));
                if ((int_fab_onlick_value == 1) || str_session_game_entry_point_value.equalsIgnoreCase("No data")) {
                    if (tv_onclick_tailor_txt.getText().toString().isEmpty()) {
                        Toast.makeText(getActivity(), "Please Select Tailor", Toast.LENGTH_SHORT).show();
                    } else if (tv_onclick_operation.getText().toString().isEmpty()) {
                        Toast.makeText(getActivity(), "Please Select Operation", Toast.LENGTH_SHORT).show();
                        ...
                        dialog_for_pieces = new Dialog(requireActivity());
...
//                } else if (str_session_game_entry_point_value.equals("2") || str_session_game_entry_point_value.equalsIgnoreCase("No data")) {
                } else if ((int_fab_onlick_value == 2) || str_session_game_entry_point_value.equalsIgnoreCase("No data")) {
                    if (tv_onclick_io_number_manual_entry_txt.getText().toString().isEmpty()) {
                        Toast.makeText(getActivity(), "Please Select IO Number", Toast.LENGTH_SHORT).show();
                    } else if (tv_onclick_color_manual_entry_txt.getText().toString().isEmpty()) {
                        Toast.makeText(getActivity(), "Please Select Color", Toast.LENGTH_SHORT).show();
    ...
    private void Get_Bundle_Number_Details() {
        try {
            try {
...
//                Log.e("json_bundle_no", jsonObject.toString());
                APIInterface apiInterface = Factory.getClient();
                Call<Operator_Model> call = apiInterface.BUNDLE_NUMBER̥_CODE_RESPONSE_CALL("application/json", jsonObject.toString());
                        ...
                        if (response.code() == 200) {
                            ...
                            if (response.isSuccessful()) {
                                if (str_status.equalsIgnoreCase("error")) {
                                    dialog_for_bundle_number.dismiss();
                                    Toast.makeText(getActivity(), "" + response.body().message, Toast.LENGTH_SHORT).show();
                                } else {
                                    rv_bundle_number.setVisibility(View.VISIBLE);
                                    bundle_number_adapter_for_checking = new Bundle_Number_Adapter_For_Checking(getActivity(), response.body().data);
                                    rv_bundle_number.setAdapter(bundle_number_adapter_for_checking);
                                }
                            }
                        } else if (response.code() == 401) {
                            dialog_for_bundle_number.dismiss();
...
//        Log.e("str_session_game_entry_point_value_temp_btnsddsd", str_session_game_entry_point_value_temp);
        ...
        try {
            ...
            String str_bundle_number_pick_for_manual_entry = SessionSave.getSession("Session_Bundle_Number_Pick_Manual_Entry", getActivity());
            if (str_bundle_number_pick_for_manual_entry.equalsIgnoreCase("No data")) {
                str_bundle_number_pick_for_manual_entry = "none";
            }
            ...
            if (str_session_game_entry_point_value_temp.equals("2")) {
                jsonObject.put("usname", str_session_username);
                jsonObject.put("token", str_session_logintoken);
                jsonObject.put("bundle_no", str_bundle_number_pick_for_manual_entry);
            ...
            call.enqueue(new Callback<Full_App_Model_Class>() {
                ...
                public void onResponse(Call<Full_App_Model_Class> call, Response<Full_App_Model_Class> response) {
                    if (response.isSuccessful()) {
                        ...
                        str_warning = response.body().warning;
//                        Log.e("statussss", String.valueOf(Objects.requireNonNull(response.body()).status));
//                        Log.e("messageee", String.valueOf(Objects.requireNonNull(response.body()).message));
                        Log.e("warningggg", String.valueOf(Objects.requireNonNull(response.body()).warning));
...
//                                if (constraintLayout_recyclerview.getVisibility() == View.VISIBLE) {
                                ...
                                rv_sewing.setVisibility(View.VISIBLE);
//                              }
                                if (!(str_warning.equalsIgnoreCase("Available"))) {
                                    dialog_for_warning = new Dialog(requireActivity());
                                    dialog_for_warning.setContentView(R.layout.warning_alert_for_sewing);
                                    TextView tv_warning_alert_text, tv_ok_for_warning;
                                    tv_warning_alert_text = dialog_for_warning.findViewById(R.id.tv_warning_alert_text);
                                    tv_ok_for_warning = dialog_for_warning.findViewById(R.id.tv_ok_for_warning);
                                    tv_warning_alert_text.setText(str_warning);
                                    Toast_Message.showToastMessage(requireActivity(), getResources().getString(R.string.successfully_submitted_txt), 6);
                                    dialog_for_warning.show();
                                    dialog_for_warning.setCancelable(false);
                                    tv_ok_for_warning.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            dialog_for_warning.dismiss();
                                        }
                                    });
                                } else {
                                    Toast_Message.showToastMessage(requireActivity(), getResources().getString(R.string.successfully_submitted_txt), 3);
                                }
                            } else if (str_session_game_entry_point_value_temp.equals("2")) {
                                ...
                                SessionSave.clearSession("Session_Bundle_Number_Pick_Manual_Entry", getActivity());
                                SessionSave.clearSession("Session_Checking_Person_Sewing_dummy", getActivity());
                                SessionSave.clearSession("Session_Operation_Sewing", getActivity());
                                SessionSave.clearSession("Session_Shift_Timing_Sewing", getActivity());
                                SessionSave.clearSession("Session_Total_Pieces_Sewing", getActivity());
...
//                    Log.e("str_merge_timings", str_merge_timings);
    ...
    private class Bundle_Number_Adapter_For_Checking extends RecyclerView.Adapter<Bundle_Number_Adapter_For_Checking.ViewHolder> {
        ArrayList<Operator_Model.Data> stringArrayList;
        Context mContext;

        public Bundle_Number_Adapter_For_Checking(FragmentActivity activity, ArrayList<Operator_Model.Data> data) {
            this.mContext = activity;
            this.stringArrayList = data;
        }
        ...
        @NonNull
        @Override
        public Bundle_Number_Adapter_For_Checking.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            View view;
            view = inflater.inflate(R.layout.bundle_number_adapter_details_layout, parent, false);
            return new Bundle_Number_Adapter_For_Checking.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final Bundle_Number_Adapter_For_Checking.ViewHolder holder, int position) {
            String str_from_time = stringArrayList.get(position).bundle_no;
            holder.tv_bundle_number_pick.setText(str_from_time);
            holder.tv_bundle_number_pick.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    tv_bundle_number_normal_manual_entry_txt.setText("");
                    SessionSave.SaveSession("Session_Bundle_Number_Pick_Manual_Entry", holder.tv_bundle_number_pick.getText().toString(), getActivity());
                    tv_onclick_bundle_number_manual_entry_txt.setText(holder.tv_bundle_number_pick.getText().toString());
                    dialog_for_bundle_number.dismiss();
                }
            });
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            TextView tv_bundle_number_pick;

            public ViewHolder(@NonNull View itemView) {
                super(itemView);
                tv_bundle_number_pick = itemView.findViewById(R.id.tv_bundle_number_pick);
            }
        }
