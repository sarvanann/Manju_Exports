...
public class Ironing_Adapter extends RecyclerView.Adapter<Ironing_Adapter.ViewHolder> {
    ArrayList<Sewing_Model.Data> dataArrayList;
    Context mContext;

    public Ironing_Adapter(FragmentActivity activity, ArrayList<Sewing_Model.Data> data) {
    ...
    @NonNull
    @Override
    public Ironing_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view;
        view = inflater.inflate(R.layout.ironing_list_details_layout, parent, false);
        return new Ironing_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Ironing_Adapter.ViewHolder holder, int position) {
