...
public class Checking_RecyclerView_Adapter extends RecyclerView.Adapter<Checking_RecyclerView_Adapter.ViewHolder> {
    ArrayList<Sewing_Model.Data> dataArrayList;
    Context mContext;

    public Checking_RecyclerView_Adapter(FragmentActivity activity, ArrayList<Sewing_Model.Data> data) {
    ...
    @NonNull
    @Override
    public Checking_RecyclerView_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view;
        view = inflater.inflate(R.layout.checking_recyclerview_list_details_layout, parent, false);
        return new Checking_RecyclerView_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Checking_RecyclerView_Adapter.ViewHolder holder, int position) {
