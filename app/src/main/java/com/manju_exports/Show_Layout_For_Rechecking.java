...
public class Show_Layout_For_Rechecking extends AppCompatActivity {
    Fragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_layout_for_rechecking);
        ...
        str_session_value_for_integer = SessionSave.getSession("session_jsonKeyvalues_Rechecking", Show_Layout_For_Rechecking.this);
        str_session_total_pieces = SessionSave.getSession("Session_Total_Pieces_Rechecking", Show_Layout_For_Rechecking.this);
        str_session_ok_pieces = SessionSave.getSession("Session_Ok_Pieces_Rechecking", Show_Layout_For_Rechecking.this);
        str_session_defect_pieces = SessionSave.getSession("Session_Defect_Pieces_Rechecking", Show_Layout_For_Rechecking.this);
        str_session_username = SessionSave.getSession("Session_UserName", Show_Layout_For_Rechecking.this);
        str_session_logintoken = SessionSave.getSession("Session_Logintoken", Show_Layout_For_Rechecking.this);
...
//                SessionSave.SaveSession("Hashmap_Session_Values_For_Integer_Rechecking", "" + onclick_add_integer_arrayList.toString().replace("[", "").replace("]", ""), Show_Layout.this);
//                SessionSave.SaveSession("Hashmap_Session_Values_For_Mistake_Rechecking", "" + onclick_mistakes_arrayList.toString().replace("[", "").replace("]", ""), Show_Layout.this);
//                Log.e("save_total", et_total_Number.getText().toString());
//                Log.e("save_ok", et_ok_pieces.getText().toString());
//                Log.e("save_defect", tv_defect_pieces_top_layout.getText().toString());

                SessionSave.SaveSession("Session_Total_Pieces_Rechecking", et_total_Number.getText().toString(), Show_Layout_For_Rechecking.this);
                SessionSave.SaveSession("Session_Ok_Pieces_Rechecking", et_ok_pieces.getText().toString(), Show_Layout_For_Rechecking.this);
                SessionSave.SaveSession("Session_Defect_Pieces_Rechecking", tv_defect_pieces_top_layout.getText().toString(), Show_Layout_For_Rechecking.this);
...
//                        Log.e("jsonObject1_inside", jsonObject.toString());
                    ...
                    Log.e("jsonArray1_outside_for_recheck", jsonArray.toString());
//                    Log.e("jsonArrayyyyy_outside", jsonArray.toString());
                    SessionSave.SaveSession("session_jsonKeyvalues_Rechecking", jsonArray.toString(), getApplicationContext());
                    Log.e("Iff_Session_Value_rechecking", SessionSave.getSession("session_jsonKeyvalues", getApplicationContext()));
//                    Log.e("---->", jsonArray.toString());
                    Intent intent = new Intent(Show_Layout_For_Rechecking.this, Re_Checking_Act.class);
                    ...
                    Log.e("Else_Session_Value_rechecking", SessionSave.getSession("session_jsonKeyvalues", getApplicationContext()));
                    Intent intent = new Intent(Show_Layout_For_Rechecking.this, Re_Checking_Act.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("hide_layout", "1");
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (et_ok_pieces.getText().toString().trim().equals("")) {
                    ...
                    if (int_total_pieces > int_ok_pieces) {
                        ...
                        Toast.makeText(Show_Layout_For_Rechecking.this, "Ok piece is greater than total piece value", Toast.LENGTH_SHORT).show();
                        tv_defect_pieces_top_layout.setText("");
                    }
                }
            }
...
//        str_session_value_for_integer = SessionSave.getSession("Hashmap_Session_Values_For_Integer_Rechecking", Show_Layout.this);
//        str_session_value_for_mistake = SessionSave.getSession("Hashmap_Session_Values_For_Mistake_Rechecking", Show_Layout.this);
...
//        Log.e("sess_vlu_fr_mstk", str_session_value_for_mistake);
        ...
        constraintLayout_defect_pieces.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog_for_pieces = new Dialog(Objects.requireNonNull(Show_Layout_For_Rechecking.this));
                dialog_for_pieces.setContentView(R.layout.check_pieces_alert_for_recheck);
                rv_entry_pieces = dialog_for_pieces.findViewById(R.id.rv_entry_pieces);
                rv_entry_pieces.setLayoutManager(new LinearLayoutManager(Show_Layout_For_Rechecking.this, LinearLayoutManager.VERTICAL, false));
    ...
    private void Get_Mistakes_Details() {
        ...
        select_pieces_adapter = new Select_Pieces_Adapter(Show_Layout_For_Rechecking.this, defectsArrayList);
                    ...
                    if (response.code() == 200) {
                        if (response.isSuccessful()) {
                            ...
                            if (str_status.equalsIgnoreCase("error")) {
                                ...
                                Toast.makeText(Show_Layout_For_Rechecking.this, "This user doesn't have permission to access the mistake data.", Toast.LENGTH_SHORT).show();
                            } else {
                                rv_entry_pieces.setVisibility(View.VISIBLE);
                                select_pieces_adapter = new Select_Pieces_Adapter(Show_Layout_For_Rechecking.this, response.body().data);
                                rv_entry_pieces.setAdapter(select_pieces_adapter);
                            }
                        }
                    }
    ...
    public void addValue() {
        if (str_session_value_for_integer.equalsIgnoreCase("No data")) {
            if (et_total_Number.getText().toString().isEmpty()) {
                Toast.makeText(Show_Layout_For_Rechecking.this, "Please enter total no of defects", Toast.LENGTH_SHORT).show();
                et_total_Number.requestFocus();
            } else if (et_ok_pieces.getText().toString().isEmpty()) {
                Toast.makeText(Show_Layout_For_Rechecking.this, "Please enter ok Pieces", Toast.LENGTH_SHORT).show();
                et_ok_pieces.requestFocus();
            } else if (et_no_of_defect_pieces_in_bottom_layout.getText().toString().isEmpty()) {
                Toast.makeText(Show_Layout_For_Rechecking.this, "Please enter no of defects pieces", Toast.LENGTH_SHORT).show();
                et_no_of_defect_pieces_in_bottom_layout.requestFocus();
            } else if (tv_onclick_select_piece.getText().toString().isEmpty()) {
                Toast.makeText(Show_Layout_For_Rechecking.this, "Please enter mistake", Toast.LENGTH_SHORT).show();
            } else {
...
//                Log.e("mistke_arylist", String.valueOf(onclick_mistakes_arrayList.toString()));
...
//                Log.e("int_temp1", String.valueOf(int_temp1));
                ...
                if (int_temp1 == int_top_tv_defect_Pieces_in_top_layout) {
                    ...
                    btn_save_checking.setBackground(getResources().getDrawable(R.drawable.rechecking_entry_button_bg));
                }
...
//                    Log.e("aftr_remove_mistake", onclick_mistakes_arrayList.toString());
                    ...
                    et_no_of_defect_pieces_in_bottom_layout.setText("");
                    tv_onclick_select_piece.setText("");
                    Toast.makeText(Show_Layout_For_Rechecking.this, "Please enter below value", Toast.LENGTH_SHORT).show();
                }
            }
        } else {
            try {
                Log.e("kkk_rechecking", "kokokoo");
//                addValue_With_Data();
...
//                            for (int j = 0; j < ItemModelList.size(); j++) {
                        ...
                        SessionSave.SaveSession("session_jsonKeyvalues_Rechecking", jsonArray.toString(), getApplicationContext());
                        Log.e("save_json_rechecking", jsonArray.toString());
                            /*if (int_temp1 == int_top_tv_defect_Pieces_in_top_layout) {
                                btn_save_checking.setEnabled(true);
                                btn_save_checking.setBackground(getResources().getDrawable(R.drawable.rechecking_entry_button_bg));
                            }*/
//                            SessionSave.SaveSession("Hashmap_Session_Values_For_Integer_Rechecking", "" + ItemModelList.toString().replace("[", "").replace("]", ""), Show_Layout.this);
//                            SessionSave.SaveSession("Hashmap_Session_Values_For_Mistake_Rechecking", "" + ItemModelList.toString().replace("[", "").replace("]", ""), Show_Layout.this);
                    } else {
                        et_no_of_defect_pieces_in_bottom_layout.setText("");
                        tv_onclick_select_piece.setText("");
                        Toast.makeText(Show_Layout_For_Rechecking.this, "Please enter below value", Toast.LENGTH_SHORT).show();
...
//                }
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView = mInflater.inflate(R.layout.items_for_rechecking, null);
...
//                    Log.e("str_n1", jsonArray.toString());
                    SessionSave.SaveSession("Hashmap_Session_Values_For_Integer_Rechecking", "" + jsonArray.toString(), Show_Layout_For_Rechecking.this);
                    SessionSave.clearSession("Hashmap_Session_Values_For_Mistake_Rechecking", Show_Layout_For_Rechecking.this);
                    if (itemModelList.size() == 0) {
                        SessionSave.clearSession("Hashmap_Session_Values_For_Integer_Rechecking", Show_Layout_For_Rechecking.this);
                        SessionSave.clearSession("Hashmap_Session_Values_For_Mistake_Rechecking", Show_Layout_For_Rechecking.this);
    ...
    class Select_Pieces_Adapter extends RecyclerView.Adapter<Select_Pieces_Adapter.ViewHolder> {
        ...
        /*public Select_Pieces_Adapter(Show_Layout_For_Rechecking testing_act, ArrayList<String> defectsArrayList) {
                    this.mContext = testing_act;
                    this.stringArrayList = defectsArrayList;
                }*/

        public Select_Pieces_Adapter(Show_Layout_For_Rechecking testing_act, ArrayList<Operator_Model.Data> data) {
            this.mContext = testing_act;
