...
public class Show_Layout_For_Rechecking extends AppCompatActivity {
    ...
    ArrayList<String> defects_id_ArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_save_checking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("defects_id_ArrayList_log", "" + defects_id_ArrayList.toString());
                ...
                if (str_session_value_for_integer.equalsIgnoreCase("No data")) {
                    ...
                    for (int i = 0; i < onclick_add_integer_arrayList.size(); i++) {
                        ...
                        String c = defects_id_ArrayList.get(i);
                        try {
                            jsonObject.put("defect_id", c);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    ...
                    for (int i = 0; i < ItemModelList.size(); i++) {
                        ...
                        String c = ItemModelList.get(i).getId();
                        try {
                            jsonObject.put("defect_id", c);
                        } catch (JSONException e) {
                            e.printStackTrace();
    ...
    private void addValue_With_Data() {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            try {
                ...
                String str_defect_id = jsonObject.getString("defect_id");

                Model md = new Model(String.valueOf(int_Defectvalue), str_defect_name,str_defect_id);
    ...
    public void addValue() {
        if (str_session_value_for_integer.equalsIgnoreCase("No data")) {
            if (et_total_Number.getText().toString().isEmpty()) {
                ...
                defects_id_ArrayList.add(str_defect_id);
                ...
                Log.e("defects_id_ArrayList_value_add_value", defects_id_ArrayList.toString());
                ...
                if (int_temp1 <= int_top_tv_defect_Pieces_in_top_layout) {
                    Model md = new Model(String.valueOf(str_number_of_defect_pieces_in_bottom_layout), String.valueOf(str_mistake_pieces), String.valueOf(str_defect_id));
                    ItemModelList.add(md);
                    customAdapter = new CustomAdapter(getApplicationContext(), ItemModelList);
                    listView.setAdapter(customAdapter);
                    customAdapter.notifyDataSetChanged();
            ...
            imgRemove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0; i < itemModelList.size(); i++) {
                        ...
                        str_n3 = itemModelList.get(i).getId().trim();
                        try {
                            JSONObject jsonObject = new JSONObject();
                            jsonObject.put("count_value", str_n1);
                            jsonObject.put("defect_name", str_n2);
                            jsonObject.put("defect_id", str_n3);
                            jsonArray.put(jsonObject);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    class Select_Pieces_Adapter extends RecyclerView.Adapter<Select_Pieces_Adapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final Select_Pieces_Adapter.ViewHolder holder, int position) {
            ...
            holder.tv_pieces_adapter.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    str_defect_id = stringArrayList.get(position).id;
                    SessionSave.SaveSession("Session_Defect_id", str_defect_id, Show_Layout_For_Rechecking.this);
                    tv_onclick_select_piece.setText("");
