...
public class Re_Checking_Act extends FragmentActivity {
    Fragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.re_checking_act);
        ...
        tv_title_txt.setText(getResources().getString(R.string.rechecking_txt));
...
*/
        tv_exit_txt.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(Re_Checking_Act.this);
                ...
                tv_yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        Intent intent = new Intent(Re_Checking_Act.this, Home_Activity.class);
        ...
        Show_Re_Checking_Fragment();
    }

    private void Show_Re_Checking_Fragment() {
