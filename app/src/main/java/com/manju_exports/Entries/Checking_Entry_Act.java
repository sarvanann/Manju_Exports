...
public class Checking_Entry_Act extends FragmentActivity {
    Fragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title_txt.setText(getResources().getString(R.string.checking_txt));
        ...
        tv_exit_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(Checking_Entry_Act.this);
                ...
                tv_yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        Intent intent = new Intent(Checking_Entry_Act.this, Home_Activity.class);
