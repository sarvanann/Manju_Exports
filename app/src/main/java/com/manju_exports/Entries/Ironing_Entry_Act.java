...
public class Ironing_Entry_Act extends FragmentActivity {
    Fragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checking_entry_act);
        ...
        toolbar.setBackgroundColor(getResources().getColor(R.color.purple_color));
        tv_title_txt.setText(getResources().getString(R.string.ironing_txt));
...
*/
        tv_exit_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(Ironing_Entry_Act.this);
                ...
                tv_yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        Intent intent = new Intent(Ironing_Entry_Act.this, Home_Activity.class);
